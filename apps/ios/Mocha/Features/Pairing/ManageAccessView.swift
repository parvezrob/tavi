            ...
            List {
                ...
                Section {
                    ...
                    if let failure {
                        ...
                        Text("Revokes this phone's access on the Mac and forgets the Mac here. Your agents keep running. You can also revoke from the Mac with `mocha devices revoke`.")
                    }
                }
                .listRowBackground(MochaTheme.card)
