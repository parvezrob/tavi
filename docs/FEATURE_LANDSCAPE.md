...
| Voice input | Moshi, Orca, ShadowTerm and vendor apps support it. | On-device dictation into the composer, compose mode only, never auto-sent (#56, shipped 2026-09-01). | Now |
