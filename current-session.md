...
- **App Store readiness (2026-08):** milestone “App Store review readiness” + epic #37 gate any Apple submission. `codebase-scan.html` (#30) is a second-agent audit whose claims were re-verified against the code — input only, never the tracker. Near-term security hygiene filed as #31–#36 (Keychain token + truthful copy, hook argv, DEBUG-gate dev seeding, CORS removal, log perms, ephemeral URLSession).
